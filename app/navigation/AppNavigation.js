...
import WicEligible from '../containers/WicEligible/WicEligible'

import s from './AppNavigationStyles'
import Icon from 'react-native-vector-icons/dist/MaterialIcons'

export const BackButton = ({ navigation, text }) => (
  <TouchableOpacity onPress={() => navigation.goBack()} style={s.iconWrapper}>
...
const AppStack = StackNavigator(
  {
    ...
    WicEligible: { screen: WicEligible }
  },
  {
