...
class Champion extends React.Component {
  ...
  componentDidMount() {
    ...
    if (
      this.props.user.acf &&
      this.props.user.acf &&
      this.props.user.acf.champion_role
    ) {
  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView style={s.container}>
        <View style={s.head}>
          <Image style={s.backgroundImage} source={Images.championBackground} />
        </View>
        <ScrollView
          style={s.content}
          ...
          {invited && (
            <TouchableOpacity
              activeOpacity={0.7}
              style={s.championInvitedCard}
              onPress={() => setInvited(false)}>
              <Icon style={AppStyles.primaryIcon} name="trophy" />
              <Txt.View
                style={s.championInvited}
                textStyle={s.championInvitedText}>
                {I18n.t("championInvited")}
              </Txt.View>
              <Icon style={AppStyles.primaryIcon} name="pencil" />
            </TouchableOpacity>
          )}
          <Card
            style={s.card}
            title={
              <View>
                ...
                <Txt.View
                  style={[s.title, invited && s.cardTitle]}
              ...
              cover={
                <Input.Group>
                  <Link
                    ...
                    prefix={<Icon style={AppStyles.inputIcon} name="trophy" />}
                  ...
                  <Field
                    ...
                    refField="firstName"
                    prefix={<Icon style={AppStyles.inputIcon} name="user" />}
                    withRef
                  ...
                  <Field
                    ...
                    style={s.email}
                    prefix={
                      <Icon style={AppStyles.inputIcon} name="envelope" />
                    }
                    withRef
                    name="champion_email"
                  ...
                  <Field
                    ...
                    refField="phone"
                    prefix={<Icon style={AppStyles.inputIcon} name="phone" />}
                    withRef
                    name="champion_phone"
...
const mapStateToProps = state => ({
  ...
  initialValues: {
    ...
    champion_first_name: state.user.user.acf
      ? state.user.user.acf.champion_first_name
      : "",
    champion_last_name: state.user.user.acf
      ? state.user.user.acf.champion_last_name
      : "",
    champion_phone: state.user.user.acf
      ? state.user.user.acf.champion_phone
      : "",
    champion_email: state.user.user.acf
      ? state.user.user.acf.champion_email
      : ""
  }
});
